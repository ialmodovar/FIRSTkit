                    ...
                    tabsetPanel(type = "tabs",
                                ...
                                tabPanel("Mean Inference",
                                        br(),
                                         ...
                                         uiOutput("loc")),
                                tabPanel("Variance Inference",    
                                         br(),
                                         tags$b("Two Sample Variance"),
                                         uiOutput("variance")),
...
output$variance <- renderTable({
    ...
    all.var.two.sample.test(x = x,y = y,ratio=ratio,alpha = alpha)
},rownames = TRUE)
