---
title: "Multi-sample Inference and Analysis of Variance"
...
sidebarLayout(
  sidebarPanel(
    ...
    selectInput('type', 'Please select Sums of Squares type',
                    c(I = 'type1', II = 'type2', III = 'type3'), 'type3'),
...
output$var <- renderUI({
          list (selectInput("dvar", "Please Pick The Dependent Variable", choices = names(d()),selected = NULL),
                selectInput("ivar", "Please Pick The Independent Variable", choices = names(d()),selected = NULL)#,
...
output$KWSummary <- renderTable({
          ...
          colnames(XX) <- c("DF","X2-statistic","Pr(>X2)")
...
This *Shiny App* is made with the purpose to be free and educational. It comes without guarantee.
