##***************************************
##
## @file: inference-two-sample.R
##
## Perform two sample inference for the location parameter
## FIRSTkit allow for two-sample t-test 
...
all.t.two.sample.test <- function(x, y, delta0 = 0,alpha = 0.05,...){
  ...
  rownames(res) <- c("H_1: mu_1-mu_2 = delta_0","H_1: mu_1-mu_2 < delta_0", "H_1: mu_1-mu_2 > delta_0")
  res
}
