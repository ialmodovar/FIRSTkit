...
#   x_vals <- qbinom(0.99999, size = input$n_binomial, prob = input$p_binomial, lower.tail = FALSE):
#     qbinom(0.99999, size = input$n_binomial, prob = input$p_binomial, lower.tail = TRUE)
#   
#   probs <- dbinom(x_vals, size = input$n_binomial, prob = input$p_binomial)
#   
...
#   )
#   
#   # Convert x to factor for discrete plotting
#   df$x <- as.factor(df$x)
#   
#   # Create ggplot
